...
async def test_connect_candid_env_variables(monkeypatch):
    ...
    monkeypatch.setenv("TEMPORAL_ENCRYPTION_KEY", "MTIzNDU2NzgxMjM0NTY3ODEyMzQ1Njc4MTIzNDU2Nzg=")
...
async def test_connect_google_env_variables(monkeypatch):
    ...
    monkeypatch.setenv("TEMPORAL_OIDC_AUTH_URI", "https://accounts.google.com/o/oauth2/auth")
    monkeypatch.setenv("TEMPORAL_OIDC_TOKEN_URI", "https://oauth2.googleapis.com/token")
    monkeypatch.setenv("TEMPORAL_OIDC_AUTH_PROVIDER_CERT_URL", "https://www.googleapis.com/oauth2/v1/certs")
